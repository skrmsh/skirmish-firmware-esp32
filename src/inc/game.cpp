...
if (root->containsKey((key))) { var = (root->operator[]((key))); updateCallback();}

#define P_SET_IF_CONTAINED(var, key) SET_IF_CONTAINED(var, key, player.dataWasUpdated)
#define G_SET_IF_CONTAINED(var, key) SET_IF_CONTAINED(var, key, dataWasUpdated)
#define T_SET_IF_CONTAINED(var, key) SET_IF_CONTAINED(var, key, team.dataWasUpdated)
